...
"""Constants"""
BACKGROUND_IMAGE_PATH: str = "images/background_image.jpg"
REFRESH_IMAGE_PATH: str = "images/refresh.png"
SEARCH_IMAGE_PATH: str = "images/search.png"
MAIN_FRAME_WIDTH: int = 850
MAIN_FRAME_HEIGHT: int = 450
...
class WeatherApp(ctk.CTk):
    ...
    def create_widgets(self) -> None:
        ...
        self.search_button = self.create_button(self.weather_entry, "Search", self.search_img, self.update_weather, 280, 10)
    ...
    def create_heading_label(self, parent, text, x, y) -> ctk.CTkLabel:
        """
    ...
    def create_info_label(self, parent, text, x, y) -> ctk.CTkLabel:
        """
    ...
    def create_button(self, parent, text, image, command, x, y) -> ctk.CTkButton:
        """
    ...
    def update_weather(self) -> None:
        ...
        """        
        user_input = self.weather_entry.get()
    ...
    def toggle_temperature(self) -> None:
        self.weather_manager.convert_temperature()
        self.update_info_labels()

    def toggle_windspeed(self) -> None:
        self.weather_manager.convert_windspeed()
        self.update_info_labels()
